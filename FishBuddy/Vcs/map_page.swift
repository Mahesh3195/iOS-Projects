...
@available(iOS 12.0, *)
class map_page: UIViewController {
    ...
    func initialization(){
        ...
        navv.Nav_View_with_back_btn(_title: "Map", back_page: "log_catch_pg", back_obj: sign_in_page())
        self.view.addSubview(navv.back_view)
        
        navv.btm_bar(bl_hlht_btn_text: "Map")
    ...
    func design_initialization(){
        ...
        let mapView = GMSMapView(frame: CGRect(x: 0, y: 0, width: ui.get_w(o: main_view), height: ui.get_h(o: main_view)), camera: camera)
        main_view.addSubview(mapView)
        
        //map_details_view(x: 15, y: 15, w: ui.get_w(o: main_view)-30, _sbv: main_view)
